...
const Hero = () => {
  return (
    <div className=' h-screen flex justify-center items-center flex-col gap-y-10'>
      <div className=' flex flex-col justify-center items-center gap-y-7 lg:py-5'>
        <div className=' text-5xl font-semibold lg:text-6xl'>How to start with</div>
        <span className=' font-bold text-7xl bg-light-green-100 shadow-2xl  shadow-light-green-100 rounded-2xl px-3 '>DRAW</span>
      </div>
      <div className=' flex justify-center items-center flex-col font-extralight lg:text-2xl lg:font-extralight'>
